...
def send_intro_post(chat_id):
    """Пост-карточка «вот что я умею» + краткое описание Mini App + кнопка открыть приложение."""
    text = (
        "✦ Вот что я умею:\n\n"
        "💇‍♀️ Диагностика волос\n"
        "Пришлите фото — оценю тип, густоту, состояние и дам рейтинг 0–10. "
        "Слежу за прогрессом «до/после».\n\n"
        "🔍 Разбор косметики\n"
        "Фото средства → честный разбор: состав, оценка, для каких волос, "
        "плюсы и минусы. Найду аналоги дешевле и лучше.\n\n"
        "🧴 Совместимость средств\n"
        "Подскажу, что с чем сочетается, а что конфликтует.\n\n"
        "📱 Приложение Hoserka\n"
